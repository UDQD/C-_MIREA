...
public:
	...
	{
		out_stream << "Сумарный вес путей : " << m_dWeight << " длинна пути: " << m_vtVertexList.size() << std::endl;
		...
		out_stream << std::endl << "____________________________________________" << std::endl << std::endl;
	}
};